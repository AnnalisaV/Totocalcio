...
public class TestRicerca {
	...
	public static void main(String[] args) {
		...
		System.out.println(pronostico); // non e' detto che li stampi nello stesso ordine di inserimento perche' ho un Sset
		
		//delego ad essa la ricerca dei risultati compatibili
